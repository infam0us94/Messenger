...
class SingleChatAdapter : RecyclerView.Adapter<SingleChatAdapter.SingleChatHolder>() {
    ...
    class SingleChatHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        //Image
        val blocReceivedImageMassage: ConstraintLayout = view.bloc_received_image
        val blocUserImageMessage: ConstraintLayout = view.bloc_user_message
        val chatUserImage: ImageView = view.chat_user_image
        val chatReceivedImage: ImageView = view.chat_user_received_image
    ...
    private fun drawMessageImage(holder: SingleChatHolder, position: Int) {
        ...
        if (mListMessagesCache[position].from == CURRENT_UID) {
            holder.blocReceivedImageMassage.visibility = View.GONE
            ...
            holder.blocReceivedImageMassage.visibility = View.VISIBLE
