...
class HolderVoiceMessage(view: View) : RecyclerView.ViewHolder(view), MessageHolder {
    ...
    private val blocReceivedVoiceMassage: ConstraintLayout = view.bloc_received_voice
    private val blocUserVoiceMessage: ConstraintLayout = view.bloc_user_voice
    ...
    override fun drawMessage(view: MessageView) {
        if (view.from == CURRENT_UID) {
            blocReceivedVoiceMassage.visibility = View.GONE
            blocUserVoiceMessage.visibility = View.VISIBLE
            chatUserVoiceMessageTime.text =
                view.timeStamp.asTime()
        } else {
            blocReceivedVoiceMassage.visibility = View.VISIBLE
